...
nop			
blt $r4, $r1, b5	# r4 < r1 --> taken, PC = 27
nop			# flushed instruction
nop			# flushed instruction
addi $r20, $r20, 1	# r20 += 1 (Incorrect)
addi $r20, $r20, 1	# r20 += 1 (Incorrect)
...
b5: 
addi $r10, $r10, 1	# r10 += 1 (Correct)
blt $r2, $r1, b6	# r2 > r1 --> not taken, PC = 34
nop			# nop in case of flush
nop			# nop in case of flush
nop			# Spacer
addi $r10, $r10, 1	# r10 += 1 (Correct) = 4
b6: 
nop			
blt $r4, $r3, b7	# r4 < r3 --> taken, PC = 40
nop			# flushed instruction
nop			# flushed instruction
addi $r20, $r20, 1	# r20 += 1 (Incorrect)
addi $r20, $r20, 1	# r20 += 1 (Incorrect)
addi $r20, $r20, 1	# r20 += 1 (Incorrect)
b7: 
addi $r10, $r10, 1	# r10 += 1 (Correct) = 5
blt $r3, $r4, b8	# r3 > r4 --> not taken, PC = 47
nop			# nop in case of flush
nop			# nop in case of flush
nop			# Spacer
addi $r10, $r10, 1	# r10 += 1 (Correct) 
